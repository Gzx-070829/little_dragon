...
def GameStartInterface(screen, game_surface, sounds, cfg, coins=0, equipped_skin='default'):
    ...
    static_texts = [
        ...
        _centered_surface(tip_font, '按 空格 / ↑ 开始游戏', logical_h * 0.57, logical_w),
        _centered_surface(tip_font, '按 S 打开商城', logical_h * 0.64, logical_w),
        _centered_surface(tip_font, '按 ESC 退出游戏', logical_h * 0.71, logical_w),
        _centered_surface(coin_font, f'金币 {min(coins, 99999):05d}', logical_h * 0.80, logical_w),
    ]
