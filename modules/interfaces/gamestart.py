...
def GameStartInterface(screen, game_surface, sounds, cfg, coins=0, equipped_skin='default'):
    ...
    static_texts = [
        ...
        _centered_surface(tip_font, '按 D 清除存档', logical_h * 0.74, logical_w),
        _centered_surface(tip_font, '按 ESC 退出游戏', logical_h * 0.81, logical_w),
        _centered_surface(coin_font, f'金币 {min(coins, 99999):05d}', logical_h * 0.89, logical_w),
    ]
